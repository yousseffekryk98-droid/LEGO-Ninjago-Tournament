...
- **58** playable roster entries/variants covering the documented cast, regional Tox variant and supplied-video legacy fighters including Kai ZX (Ronin remains boss-only), with primary names and suit/variant labels separated in the UI;
