...
- **Full roster rollout:** [docs/FULL-ROSTER-PLAN.md](docs/FULL-ROSTER-PLAN.md)
- **Fidelity implementation plan:** [docs/FIDELITY-IMPLEMENTATION-PLAN.md](docs/FIDELITY-IMPLEMENTATION-PLAN.md)
...
- **342** playable roster entries/appearances: the original 58 Tournament/legacy fighters plus all 284 supplied all-era catalog entries, each with power metadata, normal attack, special attack, Spinjitzu, Ultimate Spinjitzu and passive; catalog fighters use clean-room procedural visuals while bespoke identity-model passes continue;
