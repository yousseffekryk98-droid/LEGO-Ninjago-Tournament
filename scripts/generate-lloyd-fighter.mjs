...
async function generate(){
  ...
  const locks=[
    ...
    [-.36,.12,-.03,.12,.23,.12,-.85,.12,.28],[.36,.11,-.04,.12,.23,.12,.84,-.12,-.28],[-.08,.50,-.15,.13,.22,.14,-.12,.15,.05],[.10,.50,-.16,.13"Âã#",.14,.12,-.15,-.05]
  ];
  locks.forEach((v,i)=>headKids.push(node(`FairLockReplaced${i}`,i%3===1?M.hairHiSphere:M.hairSphere,[v[0],v[1],v[2]],[v[3],v[4],v[5]],qEuler(v[7],v[8],v[6]))));
  // front fringe points
