...
export class TournamentGame {
  ...
  private buildArena() {
    ...
    for (let i = 0; i < 18; i++) {
      ...
      wall.position.set(Math.cos(angle) * 32.4, 1.1, Math.sin(angle) * 32.4);
    ...
    this.buildArenaGate();
    this.buildSerpentPillar(-27.0, -25.0, 0.28);
    this.buildSerpentPillar(27.0, -25.0, -0.28);
    this.buildSerpentPillar(-27.8, 23.8, 0.2);
    this.buildSerpentPillar(27.8, 23.8, -0.2);

    this.buildGong(-29.0, 0);
    this.buildGong(29.0, 0);
